---
name: yume-clean-code-principles
description: Enforces Yume's clean code principles and engineering philosophy. Use this skill whenever the user asks to write code, review code, or enforce formatting and naming conventions. For architectural guidelines, refer to yume-architecture instead.
---
...
> **Note:** The official version of this document lives at `docs/02-engineering/yume-clean-code-principles.md`.
