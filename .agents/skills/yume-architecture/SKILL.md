---
name: yume-architecture
description: Enforces Yume's Feature-Driven Modular Architecture. Use this skill whenever the user asks to design architecture, add new features, structure folders, set up routing, or establish module boundaries.
---
...
> **Note:** The official version of this document lives at `docs/02-engineering/yume-architecture.md`. Also consult `yume-api-standards.md`, `yume-database-design.md`, and `yume-development-guide.md` in that directory as appropriate.
